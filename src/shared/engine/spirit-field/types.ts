...
export const SPIRIT_SEED_USE_TAGS = ['alchemy', 'beast-nurturing', 'healing', 'qi-restoration', 'spirit-nourishing', 'body-tempering', 'marrow-wash', 'longevity', 'breakthrough', 'detox', 'meridian', 'formation'] as const;
